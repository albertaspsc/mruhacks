...
async function Application({ id }: { id: string }) {
  ...
  return (
    <div>
      <div className="flex flex-row items-start bg-muted/50 py-5">
      ...
      <div className="grid auto-rows-max gap-3 mb-4">
      ...
      <div className="flex flex-row items-center border-t bg-muted/50 px-2 pt-4 pb-0">
