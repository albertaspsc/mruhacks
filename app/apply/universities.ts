/// Generated from https://github.com/Hipo/university-domains-list
/// using the following jq command:
//
//  Currently this is only US/Canadian Schools we can add more as needed
//
/// ```
/// jq '[.[] | select(.alpha_two_code=="CA" or .alpha_two_code=="US") | .name] | sort | unique | "export const universities = \(.)"' -r world_universities_and_domains.json | prettier --parser babel
/// ```
